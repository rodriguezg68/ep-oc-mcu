...
#define ADO 0
#if ADO
#define ICM20602_DEFAULT_SLAVE_ADDRESS 0x69<<1  // Device address when ADO = 1
#else
#define ICM20602_DEFAULT_SLAVE_ADDRESS 0x68<<1  // Device address when ADO = 0
#endif
...
class ICM20602 {
    public:
        ICM20602(mbed::I2C& i2c, uint8_t slaveAddress = ICM20602_DEFAULT_SLAVE_ADDRESS);
        void    whoAmI();
        bool	isOnline();
        void    init();
        ...
        uint8_t readByte(uint8_t ICM20602_reg);
    private:
        mbed::I2C& ICM20602_i2c;
        uint8_t ICM20602_slave_addr = ICM20602_DEFAULT_SLAVE_ADDRESS;
};
